...
keymap("n", "Gd", "LspUI definition", opts)
keymap("n", "<leader>ca", "LspUI code_action", opts)
keymap("n", "<leader>rn", "LspUI rename", opts)
keymap("n", "[d", "LspUI diagnostic prev", opts)
keymap("n", "]d", "LspUI diagnostic next", opts)
